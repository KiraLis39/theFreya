...
public class TerrainShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/demo.shaders/terrainVertexShader.txt";

    private static final String FRAGMENT_FILE = "src/demo.shaders/terrainFragmentShader.txt";
