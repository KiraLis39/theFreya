...
public class GrayOptionsMesh extends Mesh {
    ...
    public GrayOptionsMesh() {
        float height = 0.56f;

        vertices[0] = new Vector3f(-0.9285f, -height, 0);
        // texCoord[0] = new Vector2f(0,0);

        vertices[1] = new Vector3f(0.665f, -height, 0);
        // texCoord[1] = new Vector2f(0.5f,0);

        vertices[2] = new Vector3f(-0.83f, height, 0);
        // texCoord[2] = new Vector2f(0,0.5f);

        vertices[3] = new Vector3f(0.665f, height, 0);
