...
public final class Constants {
    ...
    // other:
    public static final int MAX_ZOOM_OUT_CELLS = 18; // максимум отдаление карты ячеек.
    public static final int MIN_ZOOM_OUT_CELLS = 9; // максимум отдаление карты ячеек.
